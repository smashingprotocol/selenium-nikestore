	...
	public void Verify_Order_Available_Shipping_Method_APO() throws Exception{
		...
		try{
			...
			for(int i = 1; i <= rowCount; i++){
				...
				Assert.assertTrue("[PCM] Verify Order Available Shipping Method APO..PASSED", teststatus);
				StatusLog.printlnPassedResult(Config.driver,"[PCM] Verify Order Available Shipping Method APO");
			...
			StatusLog.printlnFailedResult(Config.driver,"[PCM] Verify Order Available Shipping Method APO");
