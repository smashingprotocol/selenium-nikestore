...
public class VerifyOrderAvailableShippingMethod {
	...
	@Test
	public void Verify_Order_Available_Shipping_Method() throws Exception{
		...
		try{
			...
			for(int i = 1; i <= rowCount; i++){
				...
				Checkout.changeShipAddbyZipcode(Config.driver, zipCode);
				...
				StatusLog.printlnPassedResult(Config.driver,"[PCM] Verify Order Available Shipping Method");
			...
			StatusLog.printlnFailedResult(Config.driver,"[PCM] Verify Order Available Shipping Method");
